...
/**
 * ERROR 500
 * Hauria de sortir, quan hi ha un error fatal a la web.
 *
 * Aquests errors es poden produir per una mala programació, 
 * fallos a la base de dades, etc.
 */
?>
<!DOCTYPE html>
<html>
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="subheader primary-text-color">
		<?php echo $i18n->_("Ups! Hem tingut un error fatal. ")?>
	</div>
	<hr>
    ...
    <p>
      ...
      <?php echo $i18n->_("Si l'error persisteix contacta amb l'administrador.")?>
    </p>
	</div>
	<div class="buttons-container">
		<a class="border-button" href="/" target="_blank"><?php echo $i18n->_("Pagina inicial")?></a>
		<a class="border-button" href="/" target="_blank"><?php echo $i18n->_("Hi ha un problema!")?></a>
	</div>
</div>
